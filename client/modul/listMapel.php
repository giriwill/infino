		...
		<table style="width: 100%;">
			...
			<tr>
				<td>
					...
					$sqlUjian = mysqli_query($con,"select * from tbl_ujian where (id_jurusan='".$idJurusan."' AND status_ujian='1' AND sesi_ujian='".$kelSiswa."') OR (id_jurusan='0' AND status_ujian='1' AND sesi_ujian='".$kelSiswa."')");
