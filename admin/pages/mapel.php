			    ...
			    $("#btnMulaiTambah").click(function(){
			    	...
			    	$.ajax({
			            ...
			            success : function(data){
			                ...
			                $(".loadon").load("data/data_mapel.php?katakunci="+katakunci);
			                $(".modalTambah").hide();
			                alert("Penambahan Mapel Telah Berhasil");
			                $(".bloker").hide();
			            }
			        });
			    });
...
<body>
	...
	<div class="box2">
		<b>Administrasi / Mapel</b>
		<br><br><br>
		<input type="text" class="input" id="search" placeholder="Search">
		&nbsp
		<button class="button" id="btnTambah"><img style="margin-right: 5px;" src="images/plus.png">Tambah Mapel</button>
		<br><br>
	...
	<div class="modalTambah">
		<table border="0" cellspacing="10" width="100%">
			<tr>
				<td><input type="text" id="nama" class="input" placeholder="Nama Mata Pelajaran" style="width: 100%"></td>
			</tr>
			<tr>
